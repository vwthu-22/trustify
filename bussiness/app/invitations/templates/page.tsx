        ...
        <div className="space-y-8">
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-gray-500 mt-1">Manage your review invitation templates</p>
                </div>
                    ...
                    <div className="bg-white rounded-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                        ...
                        <div className="p-6 space-y-4">
                            ...
                            <div className="p-4 bg-blue-500 text-white rounded-lg text-center">
                                <button className="font-semibold text-lg">Leave a Review</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="bg-blue-50 rounded-xl border border-blue-200 p-6">
                <h3 className="text-lg font-bold text-gray-900 mb-4">Available Variables</h3>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div className="p-3 bg-white rounded-lg border border-blue-200">
                        ...
                        <p className="text-xs text-gray-600 mt-1">Service/Product</p>
                    </div>
                    <div className="p-3 bg-white rounded-lg border border-blue-200">
                        <code className="text-sm text-blue-600 font-mono">{'{{branch}}'}</code>
                        <p className="text-xs text-gray-600 mt-1">Branch name</p>
                    </div>
                </div>
            </div>
        </div>
