...
export default function Travel() {
    ...
    return (
        <div className="rounded-md mt-8 sm:mt-10">
            <div className="px-0 sm:px-4 lg:px-6 rounded-lg py-4 sm:py-6">
                <div className="flex items-center justify-between mb-3 sm:mb-4">
                    <h2 className="text-xl sm:text-2xl text-gray-900">Best in Travel</h2>
                    <Link
                ...
                {isLoading ? (
                    ...
                    <div className="bg-white rounded-2xl border border-gray-300 p-6 sm:p-8 text-center">
                        <p className="text-gray-600">No travel companies found.</p>
                    </div>
                ) : (
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
